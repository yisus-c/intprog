	...
	public static void main(String[] args)throws IOException {
		...
		do {
			try {
				...
				int cantidadTiendas[] = new int [cantidadCiudades];
				int cantidadEmpleados[][] = new int [cantidadCiudades][];
				int ventasTiendas[][] = new int [cantidadCiudades][];
				int ventasCiudad[] = new int [cantidadCiudades];
